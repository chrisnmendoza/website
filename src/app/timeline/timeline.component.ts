...
export class TimelineComponent implements OnInit {
  ...
  description: string[] = ["Skills Used: ", "Skills Used: ", "Skills Used: ", "Skills Used: ", "Skills Used: ", "Skills Used: "];
  list: string[] = ["Agile Methodology, C#, Angular, Solidity, Ethereum Blockchain Development", "Java, JavaFX, Maven", "C, PIC32MX Microprocessors, MPLAB IDE", "Tableau, Excel (Pivot Tables)", "VHDL, Vivado, VMWare Workstation", "Excel, Daily Work Reports"];
  skills: string[] = ["Agile Methodology, C#, Angular, Solidity, Ethereum Blockchain Development", "Java, JavaFX, Maven", "C, PIC32MX Microprocessors, MPLAB IDE", "Tableau, Excel (Pivot Tables)", "VHDL, Vivado, VMWare Workstation", "Excel, Daily Work Reports"];
  desc: string[] = [
