...
export class TimelineComponent implements OnInit {
  ...
  description: string[] = ["Skills Used: ", "Skills Used: ", "Skills Used: ", "Skills Used: ", "Skills Used: ", "Skills Used: ", "Skills Used: ", "Skills Used: ", "Skills Used: "];
  list: string[] = ["Agile Methodology, C#, Angular, Solidity, Ethereum Blockchain Development", "Java, JavaFX, Maven", "C, PIC32MX Microprocessors, MPLAB IDE", "Tableau, Excel (Pivot Tables)", "VHDL, Vivado, VMWare Workstation", "Excel, Daily Work Reports", "Java, REST API Development, TypeScript", "Groovy, Katalon, Gosu, Bamboo, Jenkins", "AWS Components: [Lambda, Kinesis, CloudWatch, ECS/Fargate, Eventbridge], Java, REST API Development, Python, TypeScript"];
  skills: string[] = ["Agile Methodology, C#, Angular, Solidity, Ethereum Blockchain Development", "Java, JavaFX, Maven", "C, PIC32MX Microprocessors, MPLAB IDE", "Tableau, Excel (Pivot Tables)", "VHDL, Vivado, VMWare Workstation", "Excel, Daily Work Reports", "Java, REST API Development, TypeScript", "Groovy, Katalon, Gosu, Bamboo, Jenkins", "AWS Components: [Lambda, Kinesis, CloudWatch, ECS/Fargate, Eventbridge], Java, REST API Development, Python, TypeScript"];
  desc: string[] = [
    ...
    "I worked on a Java-based REST API (the same as my internship), and a Python-based service. The biggest change from internship to full time is the responsibility of evaluating different AWS components, and implementing the service to use those components."
  ]
